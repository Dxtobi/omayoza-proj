      ...
      <section>
        <div className='flex flex-col md:flex-row  justify-between'>
          <div className=' md:w-2/5 w-full'>
            {/* <img src="r101.png" alt="" className='w-[100%] max-h-[50vh] md:h-[100vh] object-cover  h-screen' /> */}
            <img src="r101.png" alt="" className='w-[90%] object-fill  h-screen' />
          </div>
          ...
          <div className='flex flex-col items-center gap-4 w-full md:w-1/2 justify-center  md:min-h-[100vh] mb-3 md:md-0'>
            ...
            <div className='w-full'>
              <div className='gap-4 flex flex-col w-[70%] items-center m-auto'>
                ...
                <p className='self-end text-gray-400 text-xs'>Forgot Password</p>
              </div>
            </div>
            <button className='text-gray-300 p-4 bg-[#85714D] w-1/5' onClick={on_submit}>Login</button>
            <div className='font-bold'>Or</div>

            <div className='flex flex-col gap-1'>
              <button className='text-gray-400 '>Login with Google</button>
              <button className='text-gray-400 '>Login with Facebook</button>
              <button className='text-gray-400 '>Login with Apple</button>
            </div>
          </div>
