      ...
      <section>
              <div className='flex gap-4 justify-between'>
                ...
                <div className='flex flex-col items-center gap-4 w-1/2 justify-center min-h-[100vh]'>
                  <div className='font-bold text-2xl uppercase'>Sign Up</div>
                    <div className='w-full'>
                      ...
                      <button className='text-gray-300 p-4 bg-[#85714D] w-1/2' onClick={on_submit}>Sign Up</button>
                    <div className='font-bold'>Or</div>

                    <div className='flex flex-col gap-1'>
                        <button className='text-gray-300 '>SignUp with Google</button>
                        <button className='text-gray-300 '>SignUp with Facebook</button>
                        <button className='text-gray-300 '>SignUp with Apple</button>
                    </div>
                    </div>
